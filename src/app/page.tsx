    ...
    <div className="space-y-8">
      <section className="text-center py-12">
        ...
        <div className="flex justify-center space-x-4 mt-6">
          ...
          >
            <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
              <path d="M12.0119 0.00195312C5.38345 0.00195312 0 5.38541 0 12.0139C0 18.6424 5.38345 24.0258 12.0119 24.0258C18.6404 24.0258 24.0238 18.6424 24.0238 12.0139C24.0238 5.38541 18.6404 0.00195312 12.0119 0.00195312ZM12.0119 2.40568C17.3118 2.40568 21.6201 6.71399 21.6201 12.0139C21.6201 17.3138 17.3118 21.6221 12.0119 21.6221C6.71199 21.6221 2.40368 17.3138 2.40368 12.0139C2.40368 6.71399 6.71199 2.40568 12.0119 2.40568ZM11.7358 7.0119C9.4939 7.0119 7.6746 8.8312 7.6746 11.0731C7.6746 13.315 9.4939 15.1343 11.7358 15.1343C13.9777 15.1343 15.797 13.315 15.797 11.0731C15.797 8.8312 13.9777 7.0119 11.7358 7.0119ZM11.7358 8.61031C13.0926 8.61031 14.1986 9.7163 14.1986 11.0731C14.1986 12.4299 13.0926 13.5359 11.7358 13.5359C10.379 13.5359 9.27302 12.4299 9.27302 11.0731C9.27302 9.7163 10.379 8.61031 11.7358 8.61031ZM6.4759 11.0731C6.4759 8.1668 8.8295 5.81315 11.7358 5.81315C14.6421 5.81315 16.9957 8.1668 16.9957 11.0731C16.9957 13.9794 14.6421 16.3331 11.7358 16.3331C8.8295 16.3331 6.4759 13.9794 6.4759 11.0731ZM7.6746 11.0731C7.6746 13.315 9.4939 15.1343 11.7358 15.1343C13.9777 15.1343 15.797 13.315 15.797 11.0731C15.797 8.8312 13.9777 7.0119 11.7358 7.0119C9.4939 7.0119 7.6746 8.8312 7.6746 11.0731Z"/>
            </svg>
          </a>
        </div>
      </section>
