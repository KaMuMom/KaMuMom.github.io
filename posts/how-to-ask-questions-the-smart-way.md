...
title: "提问的智慧"
date: "2026-01-14"
excerpt: "一篇经典的技术提问指南，教你如何在技术社区中聪明地提问，获得更好的答案。"
tags: ["技术交流", "开源社区", "学习指南", "经典文章"]
---

# 提问的智慧

> **原文出处**：https://github.com/ryanhanwu/How-To-Ask-Questions-The-Smart-Way  
> **原文作者**：Eric S. Raymond, Rick Moen  
> **中文翻译**：Ryan Wu (ryanhanwu)  
> **本文章仅用于学习和分享，版权归原作者所有**
...
如果英文是你的外语（Second language），提示潜在回复者你有潜在的语言困难是好的：
...
事实上，后一个问题源自于 2001 年 8 月 在 Linux 内核邮件列表（lkml）上的一个真实的提问。我（Eric）就是那个提出问题的人。我在 Tyan S2464 主板上观察到了这种无法解释的锁定现象，列表成员们提供了解决这一问题的重要信息。
